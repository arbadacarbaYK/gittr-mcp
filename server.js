  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        publicRead: { type: 'boolean', description: 'false = private repo. Default true. Announcement name/description remain public on relays.' },
  ...
  // Agent convenience functions
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        publicRead: { type: 'boolean', description: 'false = private repo (hidden from listings, content only readable by owner/contributors). Default true. Note: the repo name/description in the kind 30617 announcement stay publicly visible on relays.' },
      },
      required: ['name'],
    },
  },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        publicRead: { type: 'boolean', description: 'false = private fork. Default true.' },
      },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        relays: { type: 'array', items: { type: 'string' } },
        graspServer: { type: 'string' },
        publicRead: { type: 'boolean', description: 'false = private mirror. Default true.' },
      },
