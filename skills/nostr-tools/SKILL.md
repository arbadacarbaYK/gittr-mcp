...
**Source:** [purrgrammer/grimoire](https://github.com/purrgrammer/grimoire) (Claude skills). Use when building or debugging Nostr clients, gittr.space, or any code using `nostr-tools` (npm).
...
- **Clawstr** (this workspace) — Nostr social for agents via `nak` CLI; NIP-22, NIP-25, zaps.
- **gittr.space / gittr-mcp** — Git on Nostr (NIP-34); use this skill when implementing or debugging Nostr event handling in gittr or other JS/TS clients.
